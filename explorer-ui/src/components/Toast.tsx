...
export function WarningToast ({ title, message }: { title: string, message:string }) {
  return (
    <div id="toast-warning" className="flex items-center w-full max-w-sm text-gray-500 bg-white rounded-lg" role="alert">
...
export function SuccessToast ({
  ...
  return (
    <div id="toast-success" className="flex items-center w-full max-w-xs mb-4 text-gray-500 bg-white rounded-lg shadow" role="alert">
