...
export function WarningToast ({ title, message }: {title: string, message:string}) {
  return (
    <div id="toast-warning" className="flex items-center w-full max-w-sm text-gray-500 bg-white rounded-lg dark:text-gray-400 dark:bg-gray-800" role="alert">
      ...
      <div className="flex flex-col">
        <div className="ml-3 text-base font-normal" >{title}</div>
...
export function SuccessToast ({
  ...
  return (
    <div id="toast-success" className="flex items-center w-full max-w-xs mb-4 text-gray-500 bg-white rounded-lg shadow dark:text-gray-400 dark:bg-gray-800" role="alert">
      ...
      <div className="ml-3 text-sm font-normal">{message}</div>
      <button type="button" onClick={onCloseHandler} className="ml-auto -mx-1.5 -my-1.5 bg-white text-gray-400 hover:text-gray-900 rounded-lg focus:ring-2 focus:ring-gray-300 p-1.5 hover:bg-gray-100 inline-flex h-8 w-8 dark:text-gray-500 dark:hover:text-white dark:bg-gray-800 dark:hover:bg-gray-700" data-dismiss-target="#toast-success" aria-label="Close">
