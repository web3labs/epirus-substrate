...
export default function ProcessingView (
  ...
  return (
    <div className="m-4 border">
      <div className="flex justify-between px-4 py-2 bg-neutral-500 text-gray-100">
        <h3 className="text-sm font-semibold p-2">Process Logs</h3>
        {
          (socketClosed && outcome === "success") &&
        <div className="flex gap-2 items-center">
          <button type="button" onClick={dispatchSuccess} >
            <div className="flex gap-1 items-center p-2 bg-neutral-300 rounded">
        ...
        <div className="flex gap-2 items-center">
          <button type="button" onClick={dispatchError} >
            <div className="flex gap-1 items-center p-2 bg-neutral-300 rounded link text-sm">
              <div className="text-red-500">Exited with errors</div>
        ...
        }
        {
          ...
          <div role="status" className="flex items-center">
            <svg className="inline mr-2 w-6 h-6 text-yellow-300 animate-spin fill-yellow-600" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <span className="text-xs">Your sources are being verified...</span>
          </div>
        }
      </div>
