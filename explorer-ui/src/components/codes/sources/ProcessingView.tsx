...
export default function ProcessingView (
  ...
  return (
    <div className="m-4 border rounded border-gray-800">
      <div className="flex justify-between px-4 py-2 bg-gray-800 text-gray-50">
        <div className="font-semibold">Process Logs</div>
        {
        ...
        <div className="flex gap-2 items-center font-semibold text-sm">
          <div className="text-red-400">Exited with errors.</div>
        ...
        }
        {
          ...
          <div role="status" className="flex items-center">
            <svg className="inline mr-2 w-5 h-5 text-gray-200 animate-spin dark:text-gray-600 fill-gray-600 dark:fill-gray-300" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <span className="font-semibold text-sm">Your sources are being verified.</span>
          </div>
        }
      </div>
      <textarea className="p-4 h-60 bg-gray-50 text-gray-800 w-full text-sm font-mono" value={lines.join("")} readOnly={true}></textarea>
    </div>
  )
}
