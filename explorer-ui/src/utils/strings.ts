...
/**
 * Utility function to concatenate Tailwind class names.
 *
 * @param classes a list of class names
 * @returns a concatenated version of the classes specified
 */
...
/**
 * Strips non-printable characters from the given input string.
 *
 * @param str The input string
 * @returns the input string without non-printable characters
 */
