...
export class BalancesDepositEvent {
  ...
  get isV100(): boolean {
    return (
      this.ctx._chain.getEventHash("balances.Deposit") ===
...
export class BalancesEndowedEvent {
  ...
  get isV100(): boolean {
    return (
      this.ctx._chain.getEventHash("balances.Endowed") ===
...
export class BalancesReservedEvent {
  ...
  get isV100(): boolean {
    return (
      this.ctx._chain.getEventHash("balances.Reserved") ===
      "e84a34a6a3d577b31f16557bd304282f4fe4cbd7115377f4687635dc48e52ba5"
    );
  }
...
export class BalancesTransferEvent {
  ...
  get isV100(): boolean {
    return (
      this.ctx._chain.getEventHash("balances.Transfer") ===
...
export class BalancesWithdrawEvent {
  ...
  get isV100(): boolean {
    return (
      this.ctx._chain.getEventHash("balances.Withdraw") ===
      "e84a34a6a3d577b31f16557bd304282f4fe4cbd7115377f4687635dc48e52ba5"
    );
  }
...
export class ContractsCodeStoredEvent {
  ...
  get isV100(): boolean {
    return (
      this.ctx._chain.getEventHash("contracts.CodeStored") ===
...
export class ContractsContractEmittedEvent {
  ...
  get isV100(): boolean {
    return (
      this.ctx._chain.getEventHash("contracts.ContractEmitted") ===
...
export class ContractsInstantiatedEvent {
  ...
  get isV100(): boolean {
    return (
      this.ctx._chain.getEventHash("contracts.Instantiated") ===
...
export class SystemNewAccountEvent {
  ...
  get isV100(): boolean {
    return (
      this.ctx._chain.getEventHash("system.NewAccount") ===
