...
export class ContractsCodeStorageStorage {
     ...
     *  A mapping between an original code hash and instrumented wasm code, ready for execution.
     */
    async getAsV31(key: Uint8Array): Promise<v31.PrefabWasmModule | undefined> {
        assert(this.isV31)
     ...
     *  A mapping between an original code hash and instrumented wasm code, ready for execution.
     */
    async getAsV83(key: Uint8Array): Promise<v83.PrefabWasmModule | undefined> {
        assert(this.isV83)
        return this._chain.getStorage(this.blockHash, 'Contracts', 'CodeStorage', key)
    }

    async getManyAsV83(keys: Uint8Array[]): Promise<(v83.PrefabWasmModule | undefined)[]> {
        assert(this.isV83)
        return this._chain.queryStorage(this.blockHash, 'Contracts', 'CodeStorage', keys.map(k => [k]))
    }

    async getAllAsV83(): Promise<(v83.PrefabWasmModule)[]> {
        assert(this.isV83)
        return this._chain.queryStorage(this.blockHash, 'Contracts', 'CodeStorage')
    }
...
export class ContractsContractInfoOfStorage {
     ...
     *  TWOX-NOTE: SAFE since `AccountId` is a secure hash.
     */
    async getAsV31(key: Uint8Array): Promise<v31.RawContractInfo | undefined> {
        assert(this.isV31)
        return this._chain.getStorage(this.blockHash, 'Contracts', 'ContractInfoOf', key)
    }

    async getManyAsV31(keys: Uint8Array[]): Promise<(v31.RawContractInfo | undefined)[]> {
        assert(this.isV31)
     ...
     *  TWOX-NOTE: SAFE since `AccountId` is a secure hash.
     */
    async getAsV74(key: Uint8Array): Promise<v74.ContractInfo | undefined> {
        assert(this.isV74)
        return this._chain.getStorage(this.blockHash, 'Contracts', 'ContractInfoOf', key)
    }

    async getManyAsV74(keys: Uint8Array[]): Promise<(v74.ContractInfo | undefined)[]> {
        assert(this.isV74)
        return this._chain.queryStorage(this.blockHash, 'Contracts', 'ContractInfoOf', keys.map(k => [k]))
    }

    async getAllAsV74(): Promise<(v74.ContractInfo)[]> {
        assert(this.isV74)
        return this._chain.queryStorage(this.blockHash, 'Contracts', 'ContractInfoOf')
    }
...
export class ContractsOwnerInfoOfStorage {
     ...
     *  A mapping between an original code hash and its owner information.
     */
    async getAsV31(key: Uint8Array): Promise<v31.OwnerInfo | undefined> {
        assert(this.isV31)
        return this._chain.getStorage(this.blockHash, 'Contracts', 'OwnerInfoOf', key)
    }

    async getManyAsV31(keys: Uint8Array[]): Promise<(v31.OwnerInfo | undefined)[]> {
        assert(this.isV31)
